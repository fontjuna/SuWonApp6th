...
import hwa.seung.noh.suwonapp6th.adapterview.AdapterViewExamActivity;
import hwa.seung.noh.suwonapp6th.another.AcActivity;
import hwa.seung.noh.suwonapp6th.another.BballActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addItem("화면 이동 예제", "데이터 주거니 받거니", MoveActivity.class);
        addItem("로그인", "데이터 주거니 받거니 복습", SalesManagementActivity.class);
        ...
        addItem("AdapterView", "ArrayAdapter, 모델클래스 작성, BaseAdapter, ViewHolder패턴, " +
                "아이템 클릭 리스너, Log, 롱클릭 리스너, 옵션 메뉴, Context 메뉴, " +
                "어댑터 변경 통지, SharedPreference, AlertDialog, CustomDialog, " +
                "리팩토링", AdapterViewExamActivity.class);
        ...
        addItem("농구 앱 프래그먼트 버전", "Fragment, Callback", BballActivity.class);
        addItem("프래그먼트 동적 생성", "코드로 Fragment 생성", AcActivity.class);
